  ...
  return (
    <div className="flex flex-col items-center animate-[fadeIn_0.3s_ease-in-out] w-full">
      ...
      <div className="bg-slate-800 w-full min-h-[320px] rounded-3xl shadow-2xl border border-slate-700 flex flex-col items-center justify-center p-6 pt-14 md:p-8 md:pt-16 mb-8 text-center relative touch-none select-none">
        ...
        <h2 className={`${currentWord.en.length <= 8 ? 'text-5xl md:text-6xl' :
...
window.SpellingSession = ({
  ...
  return (
    <div className="flex flex-col items-center animate-[fadeIn_0.3s_ease-in-out] w-full">
      ...
      <div className={`bg-slate-800 w-full rounded-3xl shadow-2xl border text-center transition-all duration-300 relative ${typoCount === 1 ? 'border-amber-500/80 shadow-[0_0_15px_rgba(245,158,11,0.2)]' :
        ...
        <div className={`${currentWord.en.length <= 10 ? 'text-sm' :
        ...
        <form onSubmit={handleSpellingSubmit} className="space-y-4 max-w-md mx-auto">
          ...
          {mustTypeCorrectly && (
            <div className="bg-slate-900 p-4 rounded-xl border border-emerald-900/50 mb-2">
              ...
              <span className={`${currentWord.en.length <= 8 ? 'text-3xl' :
          ...
          <input
            ...
            className={`w-full py-4 px-6 bg-slate-900 border-2 rounded-xl ${currentWord.en.length <= 8 ? 'text-xl' :
              currentWord.en.length <= 12 ? 'text-lg' :
                currentWord.en.length <= 16 ? 'text-base' : 'text-sm'
              } font-bold font-mono text-center transition-colors tracking-widest focus:outline-none ${typoCount === 1
          ...
          <button
            type="submit"
            className={`w-full py-3 font-bold rounded-xl transition-colors shadow-md text-white ${mustTypeCorrectly ? 'bg-emerald-700 hover:bg-emerald-600' : 'bg-indigo-600 hover:bg-indigo-700'
              }`}
          >
