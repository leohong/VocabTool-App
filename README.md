...
📦 **最新 Android APK 下載**：[VocabTool-v1.0.apk](file:///e:/ProjectCode/VocabTool-App/VocabTool-v1.0.apk)  
🔗 **GitHub 儲存庫網址**：[https://github.com/leohong/VocabTool-App](https://github.com/leohong/VocabTool-App)  
📚 **內建字庫檔案**：[國中 2000 單字庫](file:///e:/ProjectCode/VocabTool-App/www/2000_單字庫.txt) | [高中 7000 單字庫](file:///e:/ProjectCode/VocabTool-App/www/7000_單字庫.txt)
...
### 📲 方式一：直接安裝 APK (最快)
1. 下載專案根目錄下的 **[VocabTool-v1.0.apk](file:///e:/ProjectCode/VocabTool-App/VocabTool-v1.0.apk)**。
...
2. **同步前端程式至 Android 原生專案**：
   ```bash
   npx cap sync android
   ```

3. **開啟 Android Studio 編譯並執行**：
   ```bash
